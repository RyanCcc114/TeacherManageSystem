...
const menus = [
  {
    text: "教学大纲", // 父菜单名字
    icon: "el-icon-table-lamp", // 父菜单图标
    subMenus: [{ text: "大纲列表", routerName: 'outlineList' },{text:"新增",routerName:'OutlineAdd'}]  // 子菜单列表
  },
  {
    text: "教材教案",
    icon: "el-icon-collection",
    subMenus: [{ text: "教案列表", routerName: 'planList' }, { text: "新增", routerName: 'planAdd' }]
  },
  {
    text: "教学内容",
    icon: "el-icon-message", 
    subMenus: [{ text: "内容列表", routerName: 'contentList' },{text:"新增",routerName:'ContentAdd'}]  // 日志信息这里为空，则不会进行跳转
  },
  {
    text: "作业",
    icon: "el-icon-notebook-2", 
    subMenus: [{ text: "作业列表", routerName: 'homeworkList' }, { text: "新增", routerName: 'HomeworkAdd' }],
  },
  {
    text: "教学日历",
    icon: "el-icon-date", 
    // subMenus: [{ text: "日历", routerName: 'ProductList' }, { text: "新增", routerName: 'ProductAdd' }],
    routerName: 'Calendar' // 日志信息这里为空，则不会进行跳转
  }
].map((x, i) => {
